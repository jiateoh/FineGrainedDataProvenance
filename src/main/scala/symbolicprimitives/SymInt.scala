...
object SymImplicits {
  ...
  implicit def symInt2SymFloat(s: SymInt): SymFloat = SymFloat(s.getValue(), s.getProvenance())
  implicit def symFloat2SymInt(s: SymFloat): SymInt = SymInt(s.getValue().toInt, s.getProvenance())
  implicit def symFloat2SymDouble(s: SymFloat): SymDouble = SymDouble(s.getValue().toDouble, s.getProvenance())
  implicit def symInt2SymDouble(s: SymInt): SymDouble = SymDouble(s.getValue().toDouble, s.getProvenance())
